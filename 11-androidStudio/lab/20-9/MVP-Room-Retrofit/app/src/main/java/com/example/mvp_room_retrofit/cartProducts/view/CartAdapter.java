...
public class CartAdapter extends RecyclerView.Adapter<com.example.mvp_room_retrofit.allProducts.view.AllAdapter.ProductViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.mvp_room_retrofit.allProducts.view.AllAdapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.cart_product, parent, false);
        return new com.example.mvp_room_retrofit.allProducts.view.AllAdapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.mvp_room_retrofit.allProducts.view.AllAdapter.ProductViewHolder holder, int position) {
